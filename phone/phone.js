...
function send_message() {
  if (room == 0) {
    ...
    $.ajax({
      url: "http://cors.io/?https://cryptidzones.gearhostpreview.com/send_msg.php" + params
      }).done(function(data){});
...
function pull_text() {
  ...
  var url = "http://cors.io/?https://cryptidzones.gearhostpreview.com/phone_pull.php" + params;
